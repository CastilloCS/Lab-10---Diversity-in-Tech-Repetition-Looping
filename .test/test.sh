...
javac -encoding utf8 -classpath .:./.test/junit-platform-console-standalone-1.11.0-M2.jar .test/TestMain.java Main.java BarGraph.java ColorCode.java UtilityBelt.java
